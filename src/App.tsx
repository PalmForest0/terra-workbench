      ...
      <div className="left-side">
        <div className="header">
          <a href="https://github.com/PalmForest0/terra-workbench" target="_blank">
            <img src={`${import.meta.env.BASE_URL}/images/github-mark-white.svg`} className="github-icon" />
          </a>

          <img src={`${import.meta.env.BASE_URL}/images/icon.svg`} />
          <h1>TerraWorkbench</h1>
        </div>

        <SearchBar
          paramsChanged={(params: searchParams) => {
